...
module exponent_accelerator_mm_interconnect_0 (
	...
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> SW_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // SW_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire  [10:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> SW_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> LEDR_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // LEDR_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [10:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> LEDR_s1_agent:cp_channel
	...
	wire  [13:0] hex0_s1_agent_m0_address;                                                           // HEX0_s1_agent:m0_address -> HEX0_s1_translator:uav_address
	...
	wire  [92:0] hex0_s1_agent_rf_source_data;                                                       // HEX0_s1_agent:rf_source_data -> HEX0_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex0_s1_agent_rsp_fifo_out_data;                                                    // HEX0_s1_agent_rsp_fifo:out_data -> HEX0_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> HEX0_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // HEX0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [10:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> HEX0_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> HEX1_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // HEX1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [10:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> HEX1_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> HEX2_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // HEX2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [10:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> HEX2_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> HEX3_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // HEX3_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [10:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> HEX3_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> HEX4_s1_agent:cp_data
	...
	wire  [91:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> HEX5_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                              // HEX5_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> HEX5_s1_agent:cp_channel
	...
	wire  [91:0] sw_s1_agent_rp_data;                                                                // SW_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [91:0] ledr_s1_agent_rp_data;                                                              // LEDR_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [91:0] hex0_s1_agent_rp_data;                                                              // HEX0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [91:0] hex1_s1_agent_rp_data;                                                              // HEX1_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [91:0] hex2_s1_agent_rp_data;                                                              // HEX2_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [91:0] hex3_s1_agent_rp_data;                                                              // HEX3_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [91:0] hex4_s1_agent_rp_data;                                                              // HEX4_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [91:0] hex5_s1_agent_rp_data;                                                              // HEX5_s1_agent:rp_data -> router_012:sink_data
	...
	exponent_accelerator_mm_interconnect_0_router_003 router_003 (
	...
	exponent_accelerator_mm_interconnect_0_router_003 router_004 (
	...
	exponent_accelerator_mm_interconnect_0_router_002 router_005 (
	...
	exponent_accelerator_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	exponent_accelerator_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	exponent_accelerator_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	exponent_accelerator_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	exponent_accelerator_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
